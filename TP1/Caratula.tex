...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\large Trabajo Práctico de Laboratorio Nº 1}\\[0.5cm] % Minor heading such as course title
	
	%-------------------- Title ----------------------------
	\HRule\\[0.4cm]
	{\huge\bfseries Amplificadores \\[5pt] Monoetapa }\\[0.4cm] % Title of your document
	\HRule\\[1.5cm]
	...
	\begin{minipage}{0.4\textwidth}
		\begin{flushright}
			...
			\\[20pt]
			\textit{Ayudante}\\
			\textsc{Ing. Alejandro Furfaro} % Supervisor's name
		\end{flushright}
	\end{minipage}
	...
	{\large Octubre 23 de 2019} % Date, change the \today to a set date if you want to be precise
